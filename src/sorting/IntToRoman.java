...
public class IntToRoman {
	...
	private StringBuilder onesMap(StringBuilder builder, int num) {
		switch (num) {
		case 0:
			break;
		case 1:
	...
	private StringBuilder tensMap(StringBuilder builder, int num) {
		if (num == 4) {
			builder.append("XL");
		}
	...
	private StringBuilder hundredsMap(StringBuilder builder, int num) {
		if (num == 4) {
			builder.append("CD");
		}
	...
	private StringBuilder thousnadsMap(StringBuilder builder, int num) {
		while (num > 0) {
			builder.append("M");
			num--;
		}
